...
public class FormOverlay extends javax.swing.JFrame {
    ...
    int yMouse;
    Thread theRobot;
    BufferedImage theTarget;
    BufferedImage theAction;
    BufferedImage theActionInProgress;

    public FormOverlay(BufferedImage target, BufferedImage action, BufferedImage actionInProgress) {
	theTarget = target;
	theAction = action;
